...
import { TipoMenu, SubcategoriaMenu } from '../entities/producto.entity';
...
export class CreateProductoDto {
  ...
  @ApiPropertyOptional({ enum: SubcategoriaMenu, example: SubcategoriaMenu.FONDO })
  @IsEnum(SubcategoriaMenu)
  @IsOptional()
